...
console.log(singleNumber([1, 2, 4, 2, 4, 1, 0]));
...
var singleNumber1 = function (nums) {
    ...
    function sum(arrayLike) {
        return arrayLike.reduce((prev, next) => prev + next)
    }
    return 2 * sum(setArr) - sum(nums)
}

console.log(singleNumber1([1, 2, 4, 2, 4, 1, 0]));


// 四种方法及解析 https://leetcode.com/articles/single-number/
// Approach 1: List operation
// Approach 2: Hash Table ({})
// Approach 3: Math (Set)
// Approach 4: Bit Manipulation (满足题目要求)